      ...
      <table className="w-full border-collapse text-sm">
        <thead>
          <tr className="border-b border-border text-left text-ink-muted">
            ...
            <SortableTh label="Conversión" sortableKey="conversionRate" activeKey={sortKey} sortDir={sortDir} onSort={handleClick} />
            <SortableTh label="Abandono" sortableKey="abandonmentRate" activeKey={sortKey} sortDir={sortDir} onSort={handleClick} />
            <SortableTh label={'Cancelados "casi llegan"'} sortableKey="nearMissCancelledCount" activeKey={sortKey} sortDir={sortDir} onSort={handleClick} />
          </tr>
        </thead>
        <tbody>
          ...
          {sorted.length === 0 && (
            <tr><td colSpan={4} className="py-4 text-center text-ink-faint">Sin datos en este filtro.</td></tr>
          )}
        </tbody>
      </table>
    </div>
